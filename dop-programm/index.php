...
$APPLICATION->SetPageProperty("title", "Дополнительные опции | Салон «Teatro»");
$APPLICATION->SetTitle("dop-programm");
?>
    ...
    <div class="container">
        ...
        <?$APPLICATION->IncludeComponent("bitrix:news.list", "programm-list", Array(
