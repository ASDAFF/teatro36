...
?>
	...
	<div class="container">
		...
		<?$APPLICATION->IncludeComponent("bitrix:news.list", "offer-list", Array(
			...
			"IBLOCK_ID" => "6",	// РљРѕРґ РёРЅС„РѕСЂРјР°С†РёРѕРЅРЅРѕРіРѕ Р±Р»РѕРєР°
			"IBLOCK_TYPE" => "services",	// РўРёРї РёРЅС„РѕСЂРјР°С†РёРѕРЅРЅРѕРіРѕ Р±Р»РѕРєР° (РёСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ С‚РѕР»СЊРєРѕ РґР»СЏ РїСЂРѕРІРµСЂРєРё)
		...
		<div class="breadcrumbs">
			<a href="/" class="pathway">Главная</a> <img src="/media/system/images/arrow.png" alt=""  /> <span>Спецпредложения</span></div>
