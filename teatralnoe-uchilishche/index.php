...
?>
    ...
    <div class="container">
                ...
                <div class="scrollcontent scrollbar-inner1">
                    <div class="item-page scrollbar style-3">
                        ...
                        <div class="study-info"><p style=" color: #756183;  font-family: Calibri; font-size:22px; padding-left:5px;">Для дам</p></br>
                            <p>Милые дамы, мы рады представить Вам наши курсы по искусству эротического массажа. Это весьма полезный навык, который по достоинству оцените Вы и конечно, Ваши кавалеры. Станьте кудесницей удовольствий!</p>
                            <p>Курс состоит из трех часовых занятий: массаж ног, классический массаж, эротический массаж.</p>
                        ...
                        font-family: Calibri;">Стоимость: 5000руб.</p><br/><br/>
                            ...
                            <p>Господа, предлагаем Вашему вниманию курсы эротического массажа. Тело женщины - как музыкальный инструмент и от вашего умения на нем играть, зависит красота мелодии. Овладейте искусством доставить незабываемое удовольствие Вашей даме!</p>
                            <p>Курс состоит из трех часовых занятий: массаж ног, классический массаж, эротический массаж.</p>
        ...
        <div class="breadcrumbs">
            <a href="/" class="pathway">Главная</a> <img src="/media/system/images/arrow.png" alt=""  /> <span>Репертуар</span> <img src="/media/system/images/arrow.png" alt=""  /> <span>Театральное училище</span></div>
